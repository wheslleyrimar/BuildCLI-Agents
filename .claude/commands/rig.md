---
description: Wire the Claude Code harness into this project — hooks, band-scoped permissions, and an audit journal.
arguments: (optional) --minimal for hooks only, --full for hooks + permissions + scripts
output: .claude/settings.json  |  .buildcli/journal/  |  .buildcli/hooks/session-end.sh
