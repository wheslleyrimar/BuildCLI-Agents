---
name: delivery
description: Implement CI/CD pipelines, deployment configuration, environment management, and monitoring with focused code generation and minimal context overhead. Reads only [band:delivery] from .buildcli/context.md.
---
