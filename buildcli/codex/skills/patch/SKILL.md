...
Defect description and/or file path(s). Add --trace to file a defect blueprint.

## Output

Code fix + root cause. With --trace: blueprints/defects/<slug>/brief.md and a moved .buildcli/active.
## Steps
