---
name: store
description: Implement schema design, migrations, model changes, query performance, and caching with focused code generation and minimal context overhead. Reads only [band:store] from .buildcli/context.md.
---
