---
name: verify
description: Implement unit tests, integration tests, E2E scenarios, and the coverage gaps between them with focused code generation and minimal context overhead. Reads only [band:verify] from .buildcli/context.md.
---
