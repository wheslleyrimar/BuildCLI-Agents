...
arguments: (optional) --minimal (journal only) | --full (default: journal + resume) | --enforce (adds blocking gates)
output: .codex/hooks.json | .buildcli/bands.json | .buildcli/enforce.json | .buildcli/journal/
agent_role: Codex
---
