---
name: service
description: Implement endpoints, business logic, services, auth, and outbound integrations following project conventions. Model-agnostic — works with any model powering Copilot. Reads only [band:service] from .buildcli/context.md.
---
