---
name: interface
description: Implement components, pages, client state, routing, styling, and the layer that talks to the API following project conventions. Model-agnostic — works with any model powering Copilot. Reads only [band:interface] from .buildcli/context.md.
---
