...
Steps:
1. If I passed `--trace`, first create `blueprints/defects/<slug>/brief.md` (summary, root cause hypothesis, affected files, acceptance criterion) and run `.buildcli/runtime/bcx active blueprints/defects/<slug>`.
